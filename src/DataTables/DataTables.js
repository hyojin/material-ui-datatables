...
class DataTables extends Component {
  ...
  render() {
    ...
    let start = (currentPage - 1) * rowSize + 1;
    let end = (currentPage - 1) * rowSize + rowSize;
    const totalCount = total === 0 ? data.length : total;
    let previousButtonDisabled = currentPage === 1;
